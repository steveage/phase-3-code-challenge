...
#A band should have a method Band#concerts should return an array of all that band's concerts
...
#A band should have a mathod Band#venues that returns an array of all the venues the band has concerts at.
